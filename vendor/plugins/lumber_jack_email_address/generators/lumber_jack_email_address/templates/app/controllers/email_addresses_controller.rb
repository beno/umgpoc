# This class wraps LumberJack::EmailAddressesController as installed with the plugin. If you 
...
# The plugin.
class EmailAddressesController < LumberJack::EmailAddressesController 
